            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        ...
                        <i class="fa-solid fa-person-shelter text-white" style="font-size: 2rem;"></i>
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">Warehouse Manager</a>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Warehouse Directory</h3>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Warehouse A</td>
                                        <td>123 Storage Lane, Dhaka</td>
                                        <td>2</td>
                                        <td><span class="badge badge-info">65%</span></td>
                                        <td><span class="badge badge-warning">24°C</span></td>
                                    ...
                                    <tr>
                                        <td>Warehouse B</td>
                                        <td>456 Storage Road, Chittagong</td>
                                        <td>5</td>
                                        <td><span class="badge badge-info">70%</span></td>
                                        <td><span class="badge badge-warning">22°C</span></td>
