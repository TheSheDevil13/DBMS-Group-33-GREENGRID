...
<head>
    ...
    <title>Agricultural Analysts - GreenGrid</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Agricultural Analysts</h1>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <button class="btn btn-success" data-toggle="modal" data-target="#addOfficerModal">
                                <i class="fas fa-plus"></i> Add New Analyst
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Agricultural Analysts Directory</h3>
                        </div>
                        <div class="card-body">
