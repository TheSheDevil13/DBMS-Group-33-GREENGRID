                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <button class="btn btn-success"><i class="fas fa-plus mr-1"></i> New Order</button>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Search Order ID/Shop Name">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                <button class="btn btn-secondary"><i class="fas fa-filter mr-1"></i> Advanced Filter</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="badge badge-info">Advance Paid</span></td>
                                    <td>
                                        ...
                                        <button class="btn btn-info btn-sm" title="Track"><i class="fas fa-truck"></i></button>
                                    </td>
                                </tr>
                                <tr>
                                    <td>ORD-2024-002</td>
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm" title="View Details"><i class="fas fa-eye"></i></button>
                                        <button class="btn btn-info btn-sm" title="Track"><i class="fas fa-truck"></i></button>
                                        <button class="btn btn-warning btn-sm" title="Update Status"><i class="fas fa-edit"></i></button>
                                    </td>
                                </tr>
                                <tr>
                                    <td>ORD-2024-003</td>
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm" title="View Details"><i class="fas fa-eye"></i></button>
                                        <button class="btn btn-success btn-sm" title="Process"><i class="fas fa-cog"></i></button>
