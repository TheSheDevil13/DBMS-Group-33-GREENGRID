...
<body class="sidebar-mini">
    <div class="wrapper">
        <!-- Copy the entire navbar section from dashboard.html -->
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                <!-- Messages, Notifications, Alerts sections from dashboard.html -->
                // ... copy the entire navbar content ...
            </ul>
        </nav>

        <!-- Copy the entire sidebar section from dashboard.html -->
        <aside class="main-sidebar sidebar-dark-custom elevation-4">
            ...
            // ... copy the entire sidebar content ...
        </aside>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="warehouse.html">Warehouse</a></li>
                                ...
                                <div class="col-md-6">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            <span class="info-box-text">Warehouse Name</span>
                                            <span class="info-box-number">Warehouse A</span>
                                        </div>
                                    </div>
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number">123 Storage Lane, Dhaka</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number">24°C</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
