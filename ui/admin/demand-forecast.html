...
<head>
    ...
    <title>Demand Forecast - GreenGrid</title>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-3">
                                            <div class="info-box bg-green-1">
                                                <span class="info-box-icon"><i class="fas fa-arrow-trend-up"></i></span>
                                                <div class="info-box-content">
                                                    <span class="info-box-text">Highest Demand</span>
                                        ...
                                        <div class="col-md-3">
                                            <div class="info-box bg-green-2">
                                                ...
                                                <div class="info-box-content">
                                                    <span class="info-box-text">Market Share</span>
                                        ...
                                        <div class="col-md-3">
                                            <div class="info-box bg-green-3">
                                                ...
                                                <div class="info-box-content">
                                                    ...
                                                    <span class="info-box-number">Oct-Dec</span>
                                                    <span class="progress-description">
                                                        Planning required
                                                    </span>
                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="info-box bg-green-4">
                                                ...
                                                <div class="info-box-content">
                                                    <span class="info-box-text">Supply Risk</span>
                                                    <span class="info-box-number">Low</span>
                                                    <span class="progress-description">
                                                        Monitor wheat supply
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="card">
                                                <div class="card-header border-0">
                                                    <h3 class="card-title">6-Month Demand Forecast</h3>
                                                </div>
                                                <div class="card-body">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>High (95%)</td>
                                                        <td><span class="badge badge-success">Increase Production</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Wheat</td>
                                                        <td>800 tons</td>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        new Chart(demandCtx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Rice',
                    data: [1200, 1250, 1300, 1320, 1350, 1380],
                    borderColor: '#00a65a',
                    backgroundColor: '#00a65a20',
                    tension: 0.1
                }, {
                    label: 'Wheat',
                    data: [800, 810, 820, 825, 830, 840],
                    borderColor: '#ffc107',
                    backgroundColor: '#ffc10720',
                    tension: 0.1
                }, {
                    label: 'Pulses',
                    data: [400, 395, 390, 385, 382, 380],
                    borderColor: '#39cccc',
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Monthly Demand Forecast (in tons)',
                        color: '#495057'
                    },
                    legend: {
                        labels: {
        ...
        new Chart(distributionCtx, {
            type: 'doughnut',
            data: {
                labels: ['Rice', 'Wheat', 'Pulses', 'Others'],
                datasets: [{
                    data: [45, 30, 15, 10],
                    backgroundColor: [
                        '#00a65a',
